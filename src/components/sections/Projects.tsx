    ...
    <section id="projects" className="section relative overflow-hidden bg-tile-1 text-white">
      ...
      <div className="container-apple relative">
        <SectionHeading
          ...
          subtitle="Warehouse inventory, collaborative editing, streaming, real-time and e-commerce platforms with live payments — designed, shipped and debugged end to end."
        />
